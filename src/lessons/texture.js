...
export function renderTexture() {
  ...
  const boulderHeight = textureLoader.load(
    "/assets/textures/badlands-boulders-bl/badlands-boulders_height.png"
  );
  const boulderMetallic = textureLoader.load(
    "/assets/textures/badlands-boulders-bl/badlands-boulders_metallic.png"
  );
  ...
  const spaceCruiserAlbedo = textureLoader.load(
    "/assets/textures/space-cruiser-panels2-bl/space-cruiser-panels2_albedo.png"
  );
  spaceCruiserAlbedo.colorSpace = THREE.SRGBColorSpace;
  const spaceCruiserAo = textureLoader.load(
    "/assets/textures/space-cruiser-panels2-bl/space-cruiser-panels2_ao.png"
  );
  const spaceCruiserHeight = textureLoader.load(
    "/assets/textures/space-cruiser-panels2-bl/space-cruiser-panels2_height.png"
  );
  const spaceCruiserMetallic = textureLoader.load(
    "/assets/textures/space-cruiser-panels2-bl/space-cruiser-panels2_metallic.png"
  );
  const spaceCruiserNormal = textureLoader.load(
    "/assets/textures/space-cruiser-panels2-bl/space-cruiser-panels2_normal-ogl.png"
  );
  const spaceCruiserRoughness = textureLoader.load(
    "/assets/textures/space-cruiser-panels2-bl/space-cruiser-panels2_roughness.png"
  );
